 ...
 *
 * $Id: sim-zippy.c,v 1.1.1.1 2003/10/16 09:01:16 enzler Exp $
 *
 * $Log: sim-zippy.c,v $
 * Revision 1.1.1.1  2003/10/16 09:01:16  enzler
 * ZIPPY-6 array; initial import
 *
 * Revision 1.1.1.1  2003/01/23 14:46:08  plessl
 * Initial import
 *
...
/* ## cp ## enable simulation of ZIPPY array */
static unsigned int enable_zippy;
...
"latency of all pipeline operations.\n"
  ...
  /* ## cp ### enable ZIPPY extensions */
  opt_reg_flag(odb, "-enable_zippy", "run simulator with ZIPPY extensions",
	       &enable_zippy,
               /* default */FALSE,
	       /* print */TRUE,
               /* format */NULL);  
...
sim_main(void)
{
  ...
  if (enable_zippy){
    if(E_OK != zippy_init()){
      printf("fatal error: cannot init communication channels to modelsim\n");
      exit(-1);
    } else {
      printf("communication channel to modelsim established\n");
    }
  }
