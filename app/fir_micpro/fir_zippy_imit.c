...
int main(int argc, char *argv[])
{
  ...
  /***** IMITATION: OVERRULE MODE FLAGS *****/
  /***** imitates a 1-,2-4-context RU with 8 cell register sets *****/
  /*****   ie. each logical context has its own register set    *****/
  /***** FIR output will be wrong; however, sim. results nearly *****/
  /*****   fully accurate                                       *****/
  virtualizing = 1;
  overlapping = 0;
  contextstoring = 1;
...
#if DEBUG
  printf("\nexe mode (IMITATION!): virtualizing=%d, overlapping=%d, contextstoring=%d\n\n",
